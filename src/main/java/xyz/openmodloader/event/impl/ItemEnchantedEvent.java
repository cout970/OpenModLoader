...
public class ItemEnchantedEvent extends Event {
	...
	// TODO move this to our hook class when we get one.
	public static List<EnchantmentData> onItemEnchanted(EntityPlayer player, int levels, ItemStack itemstack,
			ItemStack fuel, List<EnchantmentData> enchantments) {
		final ItemEnchantedEvent event = new ItemEnchantedEvent(player, itemstack, fuel, levels, enchantments);
		Events.ITEM_ENCHANTED.post(event);
